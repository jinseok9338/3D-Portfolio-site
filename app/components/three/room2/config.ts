...
export const ROOM2_CONTENTS: Record<Room2ObjectId, ObjectContent<Room2ObjectId>> = {
  laptop: {
    ...
    description: '리드 또는 핵심 개발자로 참여한 프로젝트들',
    projects: [
      {
        name: '미소 원앱 프로젝트',
        role: 'Tech Lead & PM',
        period: '2024.04 - 현재',
        description: '4개 앱을 하나의 슈퍼앱으로 합치는 프로젝트. RN에 Module Federation 붙여서 코드 공유랑 독립 배포 둘 다 가능하게 만듦.',
        highlights: [
          '로딩 7초 → 2초 (60% 개선)',
          'Re.Pack + Hermes 최적화',
          '4개 팀 코드 공유 구조 설계',
      ...
      },
      {
        ...
        role: 'Frontend Lead',
        period: '2024.04 - 현재',
        description: 'DIOR, Burberry, Celine 등 LVMH 계열 브랜드 직원용 쇼핑몰',
        highlights: [
          '이벤트당 매출 20억+',
          'GKE 멀티테넌트 구조 설계',
          'Helm으로 브랜드별 독립 배포',
  ...
  corkboard: {
    ...
    description: '개발자로 성장하면서 거쳐온 프로젝트들',
    projects: [
      {
        name: '현대건설 하이빌더 TFT',
        role: 'Frontend Engineer',
        period: '2022.12 - 2023.10',
        description: '20억 규모 건설 관리 플랫폼 안정화 프로젝트',
        highlights: [
          '레거시 이슈 200건+ 해결',
          'jQuery → React 점진적 전환 리드',
          '성능 모니터링 대시보드 구축',
          '코드 리뷰 문화 정착',
        ],
      ...
      },
      {
        ...
        description: '영어 강사할 때 직접 만든 학원 관리 시스템. 이게 개발 시작한 계기.',
        highlights: [
          '출석/결제 자동화',
          '행정 업무 절반으로',
          '학부모 알림 기능',
